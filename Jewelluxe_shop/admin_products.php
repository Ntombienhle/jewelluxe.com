...
if(isset($_GET['delete'])){
   ...
   mysqli_query($conn, "DELETE FROM `products` WHERE id = '$delete_id'") or die('Delete query failed');
   mysqli_query($conn, "DELETE FROM `wishlist` WHERE pid = '$delete_id'") or die('Wishlist delete query failed');
   mysqli_query($conn, "DELETE FROM `cart` WHERE pid = '$delete_id'") or die('Cart delete query failed');
