...
<section class="placed-orders">
    ...
    <div class="box">
        ...
        <p> order status : <span style="color:<?php if($fetch_orders['payment_status'] == 'order placed'){echo 'green'; }else{echo 'green';} ?>"><?php echo $fetch_orders['payment_status']; ?></span> </p>
    </div>
    <?php
        }
    }else{
